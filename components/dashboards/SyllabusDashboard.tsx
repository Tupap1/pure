      ...
      {subjects.length === 0 ? (
        ...
        <>
          ...
          {synergies.length > 0 ? (
            ...
            <Card className="p-4 border border-slate-200 dark:border-slate-800 bg-slate-100/60 dark:bg-slate-900/40 flex items-center justify-between text-xs text-slate-600 dark:text-slate-400">
          ...
          <Card className="p-5 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-4">
              ...
              <div className="w-32 bg-slate-200 dark:bg-slate-900 border border-slate-300 dark:border-slate-800 h-2 rounded-full overflow-hidden">
            ...
            <div className="space-y-2">
              {activeTopics.length === 0 ? (
                <div className="p-8 text-center text-slate-500 dark:text-slate-400 text-xs font-mono border border-dashed border-slate-300 dark:border-slate-800 rounded-lg">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 justify-end">
                      ...
                      <select
                        ...
                        className="p-1 rounded bg-white dark:bg-slate-950 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-slate-200 text-xs font-mono focus:outline-none focus:border-sky-500"
                      >
